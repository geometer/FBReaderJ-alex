...
final class ZLXMLParser {
	...
	private static ConcurrentHashMap<List<String>,HashMap<String,char[]>> ourDTDMaps = new ConcurrentHashMap<List<String>,HashMap<String,char[]>>(); // FIXME: concurrency violation
	...
	private final static ConcurrentHashMap<ZLMutableString,String> ourStringMap = new ConcurrentHashMap<ZLMutableString,String>();
